[![All dependencies](https://img.shields.io/librariesio/release/npm/@arthurka/ts-reset/1.12.0?style=flat-square "All dependencies of @arthurka/ts-reset@1.12.0")](https://libraries.io/npm/@arthurka/ts-reset/1.12.0)
